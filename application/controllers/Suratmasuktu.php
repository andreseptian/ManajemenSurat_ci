...
class Suratmasuktu extends CI_Controller
{
    function __construct()
    {
        ...
        $this->load->model('Suratmasuktu_model');
    ...
    public function index()
    {
        ...
        if ($q <> '') {
            $config['base_url'] = base_url() . 'suratmasuktu?pp='.$per_page.'&q=' . urlencode($q);
            $config['first_url'] = base_url() . 'suratmasuktu?pp='.$per_page.'&q=' . urlencode($q);
        } else {
            $config['base_url'] = base_url() . 'suratmasuktu?pp='.$per_page;
            $config['first_url'] = base_url() . 'suratmasuktu?pp='.$per_page;
        }
        ...
        $config['total_rows'] = $this->Suratmasuktu_model->total_rows($q);
        $suratmasuktu = $this->Suratmasuktu_model->get_limit_data($config['per_page'], $start, $q);

        $this->load->library('pagination');
        $this->pagination->initialize($config);

        $data = array(
            'suratmasuktu_data' => $suratmasuktu,
            'q' => $q,
        ...
        $data['title'] = 'Suratmasuktu';
        $data['subtitle'] = '';
        $data['crumb'] = [
            'Suratmasuktu' => '',
        ];
        $data['code_js'] = 'suratmasuktu/codejs';
        $data['page'] = 'suratmasuktu/surat_list';
        $this->load->view('template/backend', $data);
    }

    public function read($id) 
    {
        $row = $this->Suratmasuktu_model->get_by_id($id);
        if ($row) {
            $data = array(
            ...
            $data['page'] = 'suratmasuktu/surat_read';
            $this->load->view('template/backend', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('suratmasuktu'));
        }
    }
    ...
    public function create() 
    {
        $data = array(
            'button' => 'Create',
            'action' => site_url('suratmasuktu/create_action'),
        ...
        $data['page'] = 'suratmasuktu/surat_form';
        $this->load->view('template/backend', $data);
    }
    ...
    public function create_action() 
    {
        ...
        if ($this->form_validation->run() == FALSE) {
          ...
          );$this->Suratmasuktu_model->insert($data);
        ...
        public function update($id) 
        {
            ...
            if ($row) {
                $data = array(
                    'button' => 'Update',
                    'action' => site_url('suratmasuktu/update_action'),
        ...
        public function update_action() 
        {
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                $this->Suratmasuktu_model->update($this->input->post('id_surat', TRUE), $data);
        ...
        public function delete($id) 
        {
            ...
            if ($row) {
                $this->Suratmasuktu_model->delete($id);
        ...
        public function deletebulk(){
            $delete = $this->Suratmasuktu_model->deletebulk();
            if($delete){
                $this->session->set_flashdata('message', 'Delete Record Success');
            }else{
       ...
       public function excel()
       {
        ...
        foreach ($this->Suratmasuktu_model->get_all() as $data) {
            $kolombody = 0;
    ...
    public function printdoc(){
        $data = array(
            'suratmasuktu_data' => $this->Suratmasuktu_model->get_all(),
            'start' => 0
        );
        $this->load->view('suratmasuktu/suratmasuktu_print', $data);
    }


    public function arsipkan($id){
        $arsipkan = $this->Suratmasuktu_model->setarsipkan($id);
        if($arsipkan){
            $this->session->set_flashdata('message', 'Arsipkan Surat Sukses');
        }else{
            $this->session->set_flashdata('message_error', 'Arsipkan Surat Gagal');
        }
        redirect(site_url('suratmasuktu'));
