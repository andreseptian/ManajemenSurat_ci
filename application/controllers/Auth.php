		...
		else
		{
			...
			if ($forgotten)
			{
				...
				$config = [
	               ...
	               'smtp_user' => 'ikanagb123@gmail.com',    // Ganti dengan email gmail kamu
	               'smtp_pass' => 'Ikanadmins123',      // Password gmail kamu
	               'smtp_port' => 465,
	               'crlf'      => "\r\n",
	               'newline'   => "\r\n"
           ];
           ...
           $this->email->from('ikanagb123@gmail.com');
           ...
           if ($this->email->send()) {
           	...
           	$this->session->set_flashdata('message','Email Send sucessfully, '.$this->ion_auth->messages());
