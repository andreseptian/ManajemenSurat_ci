    ...
    <table class="word-table" style="margin-bottom: 10px">
		...
		<th>Arsip</th>
            ...
            foreach ($arsipdigital_data as $arsipdigital)
            {
		      ...
		      <td><?php echo $arsipdigital->id_klasifikasi ?></td>
		      <td><?php echo $arsipdigital->id_user ?></td>
		      <td><?php echo $arsipdigital->id_unit ?></td>
		      ...
		      <td><?php echo $arsipdigital->status ?></td>
		      <td><?php echo $arsipdigital->arsip ?></td>	
                </tr>
                <?php
            }
            ?>
